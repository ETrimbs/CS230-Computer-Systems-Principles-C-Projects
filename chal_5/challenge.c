...
// Create a struct for a linked list of credentials
// Write a function to create a new linked list
// Write a function to free that linked list
// Complete 3 get and 3 set functions
